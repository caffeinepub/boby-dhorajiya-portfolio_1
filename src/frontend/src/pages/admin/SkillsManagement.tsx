...
export default function SkillsManagement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    const experience = BigInt(Number.parseInt(form.experience, 10) || 0);
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge
                        variant={
                          categoryColors[skill.category as string] as
                            | "default"
                            | "secondary"
                            | "destructive"
                            | "outline"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Select
                value={form.category}
                onValueChange={(val) =>
                  setForm((f) => ({ ...f, category: val as SkillCategory }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
