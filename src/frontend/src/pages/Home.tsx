    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 text-center">
          ...
          >
            Building secure, cross-platform mobile apps with Flutter & React
            Native. Security-first mindset. Clean architecture. Scalable
            solutions.
          </p>
          ...
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                I bring more than just code — I bring a security-first mindset,
                cross-platform expertise, and a commitment to your success.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground text-lg">
                A proven, structured approach from idea to launch.
              </p>
            </div>
          </AnimatedSection>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              },
              {
                step: "02",
                title: "Design",
                desc: "Wireframes, UI/UX design, and architecture planning.",
              },
              {
                step: "03",
                title: "Build",
                desc: "Agile development with weekly demos and feedback loops.",
              },
              {
                step: "04",
                title: "Test",
                desc: "Security audits, performance testing, and QA across devices.",
              },
              {
                step: "05",
                title: "Launch",
                desc: "App store deployment, monitoring, and post-launch support.",
              },
            ].map((item) => (
              <AnimatedSection key={item.step}>
                <div className="relative bg-card border border-border rounded-2xl p-5 text-center hover:border-primary/40 transition-colors">
                  <div className="text-3xl font-black text-primary/20 mb-2">
                    {item.step}
                  </div>
                  <h3 className="font-bold text-foreground mb-2">
                    {item.title}
      ...
      <section
        ...
        aria-label="Security-first approach"
      >
        <div className="max-w-6xl mx-auto px-6">
            ...
            <AnimatedSection>
              <div>
                ...
                <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                  I don't bolt on security as an afterthought. From day one,
                  every architectural decision considers threat models, data
        ...
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground text-lg">
                The tools I use to build world-class mobile experiences.
              </p>
            </div>
          </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Let's turn your idea into a production-ready mobile app. I'm
