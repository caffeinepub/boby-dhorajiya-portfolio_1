...
import { useGetProjectCategories, useGetProjects } from "../hooks/useQueries";
...
export default function Projects() {
    ...
    return (
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="flex gap-2 justify-center mb-8">
          {["sk-t1", "sk-t2", "sk-t3", "sk-t4"].map((key) => (
  ...
  return (
    <>
      <SEOHead
        page="projects"
        defaultTitle="Projects - Portfolio"
        defaultDescription="Browse my portfolio of projects across various technologies."
      />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center space-y-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            A collection of projects I've built, from web apps to open-source
            tools.
          </p>
        </div>
      </section>
