...
export default function Experience() {
  ...
  return (
    <>
      <SEOHead
        page="experience"
        defaultTitle="Experience - Portfolio"
        defaultDescription="My professional work experience and career history."
      />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center space-y-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            A timeline of my professional journey and the companies I've worked
            with.
          </p>
        </div>
      </section>
