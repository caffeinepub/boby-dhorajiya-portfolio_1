...
export default function Skills() {
  ...
  return (
    <>
      <SEOHead page="skills" defaultTitle="Skills - Portfolio" defaultDescription="Technical skills and expertise across various technologies." />

      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center space-y-4 max-w-3xl">
          <Badge variant="secondary">Expertise</Badge>
          <h1 className="text-4xl md:text-5xl font-bold text-foreground">Skills & Technologies</h1>
        ...
        <div className="container mx-auto px-4">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              <p className="text-muted-foreground text-lg">No skills added yet.</p>
            </div>
          )}
        </div>
      </section>
